...
using BKProjSqlServer.DataAccessLayer;
using BKProjSqlServer.Entities;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;

namespace BKProjSqlServer.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        private readonly SqlServerContext _productsDbContext;

        public ProductsController(SqlServerContext productsDbContext)
        {
